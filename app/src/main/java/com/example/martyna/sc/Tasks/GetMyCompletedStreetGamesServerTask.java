...
public class GetMyCompletedStreetGamesServerTask extends AsyncTask<Void, Void, String> {
    ...
    public GetMyCompletedStreetGamesServerTask(Context context, OnEventTaskCompleted listener) {
    ...
    protected String doInBackground(Void... urls) {
        try {
            String uri = "mobile/games/completed/"+sessionManager.getValueOfUserId();
