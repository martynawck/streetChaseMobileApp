 ...
 */
public class SetGameAsPlayedTask /*extends AsyncTask<String, Void, String>*/ {

    private final Context mContext;
    SessionManager sessionManager;
    private String urls = "";

    public SetGameAsPlayedTask ( Context context, String urls) {
    ...
    public void runVolley() {
        ...
        String url = ServerUrl.BASE_URL+"mobile/games/subscription/played/"+sessionManager.getValueOfUserId()+"/"+urls;
