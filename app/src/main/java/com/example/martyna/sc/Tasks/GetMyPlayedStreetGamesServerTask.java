...
public class GetMyPlayedStreetGamesServerTask extends AsyncTask<Void, Void, String> {
    ...
    public GetMyPlayedStreetGamesServerTask(Context context, OnEventTaskCompleted listener) {
    ...
    protected String doInBackground(Void... urls) {
        try {
            String uri = "mobile/games/takingpartingames/"+sessionManager.getValueOfUserId();
